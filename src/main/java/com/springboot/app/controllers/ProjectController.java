...
@Tag(
	    name = "Proyectos",
	    description = "Gestión de proyectos, miembros de proyecto y tareas asociadas."
	)
...
public class ProjectController {
    ...
    @Operation(
            summary = "Obtener roles disponibles para proyectos",
            description = "Devuelve la lista de roles posibles dentro de un proyecto (OWNER, EDITOR, VIEWER)."
        )
        @ApiResponses({
            @ApiResponse(
                responseCode = "200",
                description = "Lista de roles devuelta correctamente.",
                content = @Content(
                    mediaType = "application/json",
                    array = @ArraySchema(schema = @Schema(implementation = ProjectRole.class))
                )
            )
        })
	@GetMapping("/roles")
    ...
    @Operation(
        ...
        @ApiResponses({
            ...
            @ApiResponse(
                responseCode = "404",
                description = "Proyecto no encontrado o el usuario no tiene acceso.",
                content = @Content
            )
        })
	@GetMapping("/{id}")
    ...
    @Operation(
            ...
            description = "Lista todos los proyectos activos donde el usuario autenticado es OWNER."
        )
        @ApiResponses({
            @ApiResponse(
                responseCode = "200",
    ...
    @Operation(
            summary = "Crear o actualizar un proyecto",
            description = """
        ...
        @ApiResponses({
            ...
            @ApiResponse(
                responseCode = "403",
                description = "El usuario no tiene permisos para modificar el proyecto.",
                content = @Content
            )
        })
	@PostMapping
    ...
    @Operation(
            summary = "Agregar un miembro al proyecto",
            description = """
        ...
        @ApiResponses({
            @ApiResponse(
                ...
                content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = ProjectMemberDto.class)
                )
            ),
            @ApiResponse(
                responseCode = "400",
                description = "Datos inválidos o usuario/proyecto inexistente.",
                content = @Content
            ),
            @ApiResponse(
                responseCode = "403",
                description = "El usuario autenticado no es OWNER del proyecto.",
                content = @Content
            )
        })
    ...
    @Operation(
        ...
        @ApiResponses({
            @ApiResponse(
                responseCode = "201",
                description = "Tarea creada dentro del proyecto.",
                content = @Content(
                    mediaType = "application/json",
            ...
            @ApiResponse(
                responseCode = "404",
                description = "Proyecto no encontrado o inactivo.",
                content = @Content
            )
        })
	@PostMapping("/{id}/task")
    ...
    @Operation(
            summary = "Actualizar miembro de proyecto",
            description = """
        ...
        @ApiResponses({
            @ApiResponse(
                responseCode = "201",
                description = "Miembro de proyecto actualizado.",
                content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = ProjectMemberDto.class)
                )
            ...
            @ApiResponse(
                responseCode = "400",
                description = "Datos inválidos o reglas de negocio violadas (por ejemplo, último OWNER).",
                content = @Content
            ),
            @ApiResponse(
                responseCode = "403",
                description = "El usuario autenticado no tiene permisos para actualizar miembros.",
                content = @Content
            )
        })
    ...
    @Operation(
            summary = "Eliminar miembro de proyecto",
            description = """
        ...
        @ApiResponses({
            ...
            @ApiResponse(
                responseCode = "400",
                description = "Regla de negocio violada (ej. intento de eliminar al último OWNER).",
                content = @Content
            ),
            @ApiResponse(
                responseCode = "403",
                description = "El usuario autenticado no tiene permisos para eliminar miembros.",
                content = @Content
            )
        })
    ...
    @Operation(
        ...
        @ApiResponses({
            @ApiResponse(
                responseCode = "200",
                description = "Lista de miembros devuelta correctamente.",
                content = @Content(
                    mediaType = "application/json",
                    array = @ArraySchema(schema = @Schema(implementation = ProjectMemberDto.class))
                )
            ),
            @ApiResponse(
                responseCode = "403",
    ...
    @Operation(
        ...
        @ApiResponses({
            ...
            @ApiResponse(
                responseCode = "403",
                description = "El usuario no tiene permisos para ver las tareas del proyecto.",
                content = @Content
            )
        })
	@GetMapping("/{id}/tasks")
    ...
    @Operation(
        ...
        @ApiResponses({
            ...
            @ApiResponse(
                responseCode = "403",
                description = "El usuario no tiene permisos para eliminar el proyecto.",
                content = @Content
            ),
            @ApiResponse(
                responseCode = "404",
